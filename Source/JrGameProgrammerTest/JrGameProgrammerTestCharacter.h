...
#include "JrGameProgrammerTestCharacter.generated.h"
...
UCLASS(config=Game)
class AJrGameProgrammerTestCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AJrGameProgrammerTestProjectile> ProjectileClass;
